        ...
        <div className="mt-4 pb-20">
          <>
            <div className="flex flex-col items-center justify-center ">
              ...
              >
                <Image src="/materi/cair/example/title.png" alt="Logo" width={300} height={180} />
              </motion.div>
              <div className="flex flex-col md:flex-row">
                <motion.div
                  ...
                  className="mt-10"
                >
                  <Image src="/materi/cair/example/left.png" alt="" width={600} height={300} />
                </motion.div>
                <motion.div
                  className=""
                  initial={{ x: 300, opacity: 0 }}
                ...
                >
                  <Image src="/materi/cair/example/right.png" alt="" width={400} height={100} />
                </motion.div>
              </div>
            </div>
...
export default ExampleCairSection;
