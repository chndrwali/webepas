  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        desktop_cair_2: "url('/materi/cair/background-2.png')",
        mobile_cair_2: "url('/materi/cair/background-mobile-2.png')",
        desktop_cair_3: "url('/materi/cair/background-3.png')",
        mobile_cair_3: "url('/materi/cair/background-mobile-3.png')",
        desktop_cair_4: "url('/materi/cair/background-4.png')",
        mobile_cair_4: "url('/materi/cair/background-mobile-4.png')",
        desktop_cair_5: "url('/materi/cair/background-5.png')",
        desktop_cair_6: "url('/materi/cair/background-6.png')",
        mobile_cair_5: "url('/materi/cair/background-mobile-5.png')",
